function MetrScheduler(state, audioCtx, worker)
{
    ...
    this.addBeatsToQ = function(number)
    {
    ...
    this.beatsSchedulerTick = function()
    {
        if (this.Q.length > 0)
        {
    ...
    this.beatsSchedulerStart = function()
    {
        this.clearQ();
        this.nextBeatNumber = 0;
    }
    ...
    this.getDurBetweenBeats = function()
    {
    ...
    this.getWorkerTickrate = function()
    {
