import { AnimationQ, Animation as MetrAnim, ITimeProvider} from "../animation/AnimationQ"
...
export class CanvasPointerAnimaion
{
    ...
    constructor(provider: ITimeProvider, canvasBlock: HTMLCanvasElement, cnvVm: CanvasVM)
    {
    ...
    scheduleBeatVisual(beat: Beat, duration: number)
    {
        let beginFunc = () =>
        {
            this._cnvVm.isAccent = beat.number == 0
