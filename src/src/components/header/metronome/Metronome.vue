...
<template>
    <ul class="metr-block">
        ...
        <li class="metr-el" title="Toggle metronome playing">
            <SvgIconCommon :path="isPlaying ? mdiPauseCircleOutline : mdiPlayCircleOutline" :size="46"
            @click="isPlaying = !isPlaying">></SvgIconCommon>
        </li>
        <li class="metr-el">
